...
import static com.example.musix.MainActivity.ARTIST_TO_FRAG;
import static com.example.musix.MainActivity.PATH_TO_FRAG;
import static com.example.musix.MainActivity.SHOW_MINI_PLAYER;
import static com.example.musix.MainActivity.SONG_NAME_TO_FRAG;
                    ...
                    if (SHOW_MINI_PLAYER){
                        if (PATH_TO_FRAG != null){
                            ...
                            if (art != null){
                                ...
                                Glide.with(getContext()).load(R.drawable.default_image).into(albumArt);
                            }
